...
export function Formulario() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("https://mipollosabroso2.onrender.com/api/users/login", {
        method: "POST",
        headers: {
  ...
  const handleRegistro = async (e) => {
    ...
    try {
      const response = await fetch("https://mipollosabroso2.onrender.com/api/users/register", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
